//! # lau-solid-mechanics
//!
//! Continuum mechanics library implementing stress, strain, and deformation of solids.
//!
//! ## Modules
...
//! - **agent_analysis**: Agent structural analysis — stress testing agent architectural configurations
...
pub use agent_analysis::AgentStructuralAnalysis;
